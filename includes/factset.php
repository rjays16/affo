...
//     }
    ...
    public function getFundamentals($asset_id, $metrics, $start_date, $end_date, $periodicity, $currency) {
        $endpoint = $baseURL."/content/factset-fundamentals/v1/fundamentals";
        $params = array(
            $params = array(
                'Accept'     => 'application/json',
                'Content-Type' => 'application/json'
    ...
    public function Dividend($asset_id,  $currency) {
        $endpoint = $baseURL."/content/factset-global-prices/v1/annualized-dividends";
        $params = array(
            'headers' => array(
                'Accept' => 'application/json',
                'Content-Type' => 'application/json'
